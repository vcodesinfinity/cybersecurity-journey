...
The Terminal : A command line environment aka THE shell.
...
📂 The Linux Filesystem
      The base of the Filesystem doesn't have a physical drive like 🪟 but uses logical filesystem instead.
            ...
            /root : SuperUser's Home Directory aka THE “all-powerful”
    
              ##Commands
              pwd : Prints/Returns the current working directory
              whoami : returns which user you have logged in as
